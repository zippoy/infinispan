...
public class CLI extends CliCommand {
   ...
   private static AeshCommandRuntimeBuilder initialCommandRuntimeBuilder() throws CommandRegistryException {
   ...
   public static void main(Shell shell, String[] args) {
      try {
         AeshCommandRuntimeBuilder runtimeBuilder = initialCommandRuntimeBuilder();
         runtimeBuilder.shell(shell);
